...
1. Technology setup
    ...
    1. You should be able to edit this file. For example, include your name in Line 12.

    1. This file is now modified. All modifications need to be __committed__ and __pushed__ for them to be saved. We will push the changes to a __private__ repo named 'mktg_assignment'. Make sure you set the repo as private -- otherwise anyone online can see your private files!
