...
1. Technology setup
    ...
    1. Create a codespace from my [template](https://github.com/shleeneu/codespaces_template_public){target="_blank"}. Wait for it to finish setting up (10-15 min). This is where you will be coding this semester. Note: GitHub codespaces is fully online and accessible through your browser. You are welcome to install/use VS Code and quarto on your own computer if you prefer, but we will provide technical support for GitHub codespaces only.
    
    1. You should be able to create a new file by copying and pasting the starter file provided on canvas. You will work on this starter file to complete homework assignments.
